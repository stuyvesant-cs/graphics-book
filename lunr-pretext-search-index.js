...
},
{
  ...
  "type": "Section",
  "number": "2.2",
  "title": "Testing Potential Points",
  "body": " Testing Potential Points  The basic concept of Bresenham's Line Algorithm is to find potential pixels that we think would be good candidates for the line, test them, and then select the best one. To begin, we will start by restricting our line algorithm to only lines where , this will help narrow doent the possible pixels. Eventually, we can modify it to work for the other octants. We will also assume that our endpoints only have integer coordinates. With those restrictions in place, if we are drawing a line as starting at , we only have 2 candidate pixels, and :  A 9x5 grid with endpoints marked at (0, 0) and (9,3)    "
},
{
  "id": "section-4",
  "level": "1",
